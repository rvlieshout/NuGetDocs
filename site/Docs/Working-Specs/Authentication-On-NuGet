...
He clicks on the "team account" link for more information. On there, he sees some simple instructions, and he follows them. First, he logs in to NuGet.org. Frank uses his FooWare account "frank@fooware.biz". The login process succeeds automatically without him ever entering a password (using IE). _"Huh... that wasn't so bad I guess"_ he thinks. 
